...
**Video Tutorial**
1. **Episode 3: PZEM-004T to Node-RED: Real-Time Power Monitoring for Industry 4.0 [ESP32 FLProg Tutorial]**: https://youtu.be/0rrvaZvMXxE
...
2. **Episode 4: Build a Real-Time IIoT Monitoring System | ESP32 + PZEM-004T + Node-RED (Industry 4.0 Tutorial)**: https://youtu.be/4ApYzp3qerw
...
3. **Episode 5: Global IIoT Dashboard: ESP32 Remote Monitoring & Control from Anywhere [Node-RED & Remote-RED]**: https://youtu.be/Uip0XxGQ_gI
